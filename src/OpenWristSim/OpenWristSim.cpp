...
void OpenWristSim::update(mel::Time t)
{
    // limit torques
...
void OpenWristSim::set_torques(double _tau1, double _tau2, double _tau3) {
    tau1 = _tau1;
    tau2 = _tau2;
    tau3 = _tau3;
}

void OpenWristSim::set_positions(double _q1, double _q2, double _q3) {
    q1 = _q1;
    q2 = _q2;
    q3 = _q3;
...
void OpenWristSim::set_velocities(double _q1d, double _q2d, double _q3d) {
    q1d = _q1d;
    q2d = _q2d;
    q3d = _q3d;

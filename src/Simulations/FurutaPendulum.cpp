...
//a second update function that includes adding acceleration to the ball to simulate noise
void FurutaPendulum::update(mel::Time time, double tau, double ball_accel_noise) {
